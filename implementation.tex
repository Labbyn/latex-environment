...
Rozbudowano system obsługi błędów poprzez wprowadzenie globalnego mechanizmu obsługi wyjątków oraz przeprowadzono standaryzację wybranych \gls{Endpoint}ów aplikacji, w tym migrację operacji do architektury asynchronicznej.

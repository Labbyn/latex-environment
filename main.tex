...
\date{Lipiec, 2026}
\finishdate{\today}
\nabstract{Projekt ma na celu zwiększenie wydajności i efektywności pracy inżynierów w laboratoriach sprzętowych poprzez zapewnienie systemu do zarządzania, kontrolowania oraz sprawdzania właściwości sprzętu komputerowego oraz elementów eksploatacyjnych.}
\keyword{laboratoria sprzętowe}
\keyword{system}
\keyword{sprzęt komputerowy}
\keyword{elementy eksploatacyjne}

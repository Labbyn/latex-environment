...
\subsection{Repozytorium latex-environment}
\par
...
Spowodowane jest to tym, że przy budowie obrazu \gls{Docker} posiłkuje się już stworzonymi warstwami, jeśli któraś warstwa (każda instrukcja to jedna warstwa) jest inna to reszta musi zostać ponownie zbudowana co wydłuża całkowity czas budowania obrazu.
\par

...
\newglossaryentry{E2E}{
    name=E2E,
    description={(ang. End-To-End) metoda testowania oprogramowania, która sprawdza działanie całej aplikacji od poczatku do końca, symulując rzeczywiste przypadki użycia}
}

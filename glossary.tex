...
\newglossaryentry{RSC}{
    name=RSC,
    description={(z ang. React Server Components) Architektura wprowadzona w ekosystemie React, umożliwiająca renderowanie określonych komponentów wyłącznie po stronie serwera. Skutkuje to mniejszym rozmiarem kodu przesyłanego do klienta, ale wymaga specyficznej architektury serwerowej}
}
\newglossaryentry{SPA}{
    name=SPA,
    description={(z ang. Single Page Application) Jednostronicowa aplikacja internetowa. Pobiera ona pojedynczy dokument HTML na początku sesji, a następnie dynamicznie aktualizuje jego zawartość i renderuje nowe widoki w przeglądarce, bez konieczności przeładowywania całej strony}
}
\newglossaryentry{SSR}{
    name=SSR,
    description={(z ang. Server-Side Rendering) Technika renderowania, w której pełny i gotowy do wyświetlenia kod HTML strony internetowej jest generowany i przygotowywany przez serwer na żądanie użytkownika, zanim trafi do przeglądarki}
}
...
\newglossaryentry{WebGL}{
    name=WebGL,
    description={(z ang. Web Graphics Library) Niskopoziomowe, wbudowane API przeglądarkowe umożliwiające sprzętową akcelerację grafiki 2D i 3D na elemencie Canvas bez konieczności instalowania dodatkowych wtyczek}
}
